...
*/
    function _draw_stocked_attributes() {
      ...
      $out .= tep_draw_pull_down_menu('id[' . $attributes[0]['oid'] . ']',array_merge(array(array('id'=>0, 'text'=>'First select ' . $attributes[0]['oname'])), $attributes[0]['ovals']),$attributes[0]['default'], "onchange=\"i" . $attributes[0]['oid'] . "(this.form);\"") . "\n";
      $out .= '</div>' . "\n";
      ...
      for($o = 1; $o<sizeof($attributes)-1; $o++) {
        ...
        $out .= '</div>' . "\n";
        $out .= '<div class="col-md-9">' . "\n";
        $out .= tep_draw_pull_down_menu('id[' . $attributes[$o]['oid'] . ']',array(array('id'=>0, 'text'=>'Next select ' . $attributes[$o]['oname'])), '', "onchange=\"i" . $attributes[$o]['oid'] . "(this.form);\"") . "\n";
        $out .= '</div>' . "\n";
      }        
      ...
      $out .= '</div>' . "\n";
      $out .= '<div class="col-md-9">' . "\n";
      $out .= tep_draw_pull_down_menu('id[' . $attributes[$o]['oid'] . ']',array(array('id'=>0, 'text'=>'Next select ' . $attributes[$o]['oname'])), '') . "\n";
      $out .= '</div>' . "\n";
