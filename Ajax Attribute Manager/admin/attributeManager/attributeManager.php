...
// db compatibility functions
require_once('attributeManager/includes/attributeManagerCompatibility.inc.php');
...
<?php
    $q=tep_db_query("select * from products_stock where products_id='" . $products_id . "' order by products_stock_attributes");
